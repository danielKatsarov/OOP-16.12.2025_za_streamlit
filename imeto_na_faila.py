...
city_info = {
    ...
    "Скопие": {
        "hotel": ("Skopje Hotel", 60),
        "food": ("Македонска кухня", 18),
        "sight": "Каменният мост"
    },
    "Тирана": {
        "hotel": ("Tirana Plaza", 75),
        "food": ("Албанска кухня", 20),
        "sight": "Площад Скендербег"
    },
    "Рим": {
        "hotel": ("Rome Central", 110),
        "food": ("Италианска кухня", 35),
        "sight": "Колизеумът"
    },
    "Загреб": {
        "hotel": ("Zagreb Inn", 80),
        "food": ("Хърватска кухня", 25),
        "sight": "Горни град"
    },
    "Париж": {
        "hotel": ("Paris Boutique", 130),
        "food": ("Френска кухня", 40),
        "sight": "Айфеловата кула"
    },
    "Русе": {
        "hotel": ("Hotel Riga", 55),
        "food": ("Българска кухня", 18),
        "sight": "Доходното здание"
    },
    "Букурещ": {
        "hotel": ("Bucharest Center", 70),
        "food": ("Румънска кухня", 22),
        "sight": "Дворецът на парламента"
    }
}
...
transport_choice = st.selectbox(
    "Превозно средство:",
    ["Кола", "Влак", "Автобус", "Самолет"]
)

days = st.slider("Брой дни за пътуването:", 1, 14, 5)
budget = st.number_input("Твоят бюджет (лв):", 300, 10000, 2000)
